# Spec: web-static-site

## Purpose

Deploys the pre-built Astro static site (`apps/web/dist/`) to an S3 bucket served through a
CloudFront distribution, providing a public HTTPS URL for the customer-facing frontend and
backoffice pages.
