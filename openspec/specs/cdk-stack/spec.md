...
Defines the AWS CDK stack (`TcsChallengeStack`) that provisions all infrastructure resources for the order-processing platform: DynamoDB table, SQS queues, Lambda functions, managed log groups, and an API Gateway HTTP API.
