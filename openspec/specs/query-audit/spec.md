...
Defines the requirements for querying the audit trail of an order — the port extension, the application-layer handler, the service façade, and the HTTP endpoint.
